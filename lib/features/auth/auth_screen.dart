...
class _AuthScreenState extends State<AuthScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: UniversalVariable.greyBackgroundCOlor,
      body: SafeArea(
          child: Padding(
          ...
          children: [
            ...
            ListTile(
              tileColor: _auth == Auth.signup
                  ...
                  : UniversalVariable.greyBackgroundCOlor,
              title: const Text(
                "Register Account",
                style: TextStyle(fontWeight: FontWeight.bold),
              ),
              leading: Radio(
                  activeColor: UniversalVariable.secondaryColor,
                  value: Auth.signup,
                  groupValue: _auth,
                  onChanged: (Auth? val) {
                    setState(() {
            ...
            if (_auth == Auth.signup)
              Container(
                ...
                color: UniversalVariable.backgroundColor,
                child: Form(
                    key: _signUpFormKey,
                    child: Column(
                      children: [
